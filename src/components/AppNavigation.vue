<template>
  <nav class="hidden md:flex items-center space-x-6">
    ...
    <!-- Nuevo enlace al repositorio GitHub -->
    <a
      href="https://github.com/benitoanagua/NinaNote"
      target="_blank"
      rel="noopener noreferrer"
      class="text-onSurfaceVariant hover:text-primary px-3 py-2 rounded-md text-sm font-medium transition-colors flex items-center"
    >
